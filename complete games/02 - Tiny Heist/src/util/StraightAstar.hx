...
class StraightAstar {
	...
	public static function heuristic(t:Int, dir:Int, xp:Int, yp:Int):Int {
		...
		if (dir == Direction.LEFT || dir == Direction.RIGHT) xdist += 1;
		return xdist + ydist;
	}
	...
	public static function findpath(xp:Int, yp:Int):Void{
		...
		do{
			...
			if (Astar.currentsquare > Astar.mapwidth - 1) checksquare(Astar.currentsquare-Astar.mapwidth, Direction.UP, 10, xp, yp);
			if (Astar.currentsquare > 0 && Astar.pathtemp != 0) checksquare(Astar.currentsquare-1, Direction.LEFT, 10, xp, yp);
			if (Astar.currentsquare < Astar.mapwidth * Astar.mapheight && Astar.pathtemp != Astar.mapwidth - 1) checksquare(Astar.currentsquare + 1, Direction.RIGHT, 10, xp, yp);
			if (Astar.currentsquare < (Astar.mapwidth - 1) * Astar.mapheight) checksquare(Astar.currentsquare + Astar.mapwidth, Direction.DOWN, 10, xp, yp);
		}while(true);
	}
